...
import com.example.deeptraderspos.databinding.ActivityGraphReportBinding
...
class GraphReportActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.graphReport)) { v, insets ->
